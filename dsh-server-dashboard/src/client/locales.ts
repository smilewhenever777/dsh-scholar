...
export const zh = {
  ...
  'panel.retry': '重试',
  'alert.crash': '疑似崩溃：训练进程消失，已空闲 {min} 分钟',
  'alert.offlineLabel': '主机失联',
  'alert.hot': '温度告警',
  'alert.bell': '告警中心',
  'alert.clear': '清除',
  'alert.empty': '暂无告警',
  'chart.enlarge': '点击放大图表',
  'chart.overlay': '叠图',
  'chart.split': '分卡',
  'chart.exportCsv': '下载 CSV',
  'chart.copy': '复制数据',
  'chart.copied': '已复制',
  'chart.pickMetric': '选择要对比的指标',
  'chart.overlayShared': '共享 Y 轴',
  ...
  'host.pin': '固定显示（常驻看板）',
  'host.archive': '收起到其他服务器（离线也不再浮回主区）',
  'host.restore': '恢复到看板主区',
  'host.archivedTag': '已收起',
  ...
  'settings.alertIdleShort': '崩溃判定',
  'settings.alertIdleSuffix': '分钟无进程',
  'settings.alertIdleHint': 'GPU 从有训练进程变为无进程并持续该时长后，推送崩溃告警（toast + 系统通知）',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'panel.retry': 'Retry',
  'alert.crash': 'possible crash: training process gone, idle {min} min',
  'alert.offlineLabel': 'host unreachable',
  'alert.hot': 'temperature alert',
  'alert.bell': 'Alerts',
  'alert.clear': 'Clear',
  'alert.empty': 'No alerts',
  'chart.enlarge': 'Click to enlarge chart',
  'chart.overlay': 'Overlay',
  'chart.split': 'Per-GPU',
  'chart.exportCsv': 'Download CSV',
  'chart.copy': 'Copy data',
  'chart.copied': 'Copied',
  'chart.pickMetric': 'Pick a metric to compare',
  'chart.overlayShared': 'shared Y axis',
  ...
  'host.archive': 'Tuck into other servers (offline stays folded)',
  'host.restore': 'Restore to the main board',
  'host.archivedTag': 'tucked',
  ...
  'settings.alertIdleShort': 'Crash after',
  'settings.alertIdleSuffix': 'min no process',
  'settings.alertIdleHint': 'Fire a crash alert (toast + OS notification) after a GPU keeps no training process for this long',
